...
<ul class="nav-l" >
      ...
      <li class="nav-item" style="margin-top: 20px; ">
        <a class="nav-a" href="#" style="color:#fff;"></a>
        ...
        <a class="nav-a" href="#" >
            ...
            <div style="color:#fff;">
                <div id="wrap" style="float: left; ">
                    <img class="avatar" src="https://media.istockphoto.com/id/1131164548/vector/avatar-5.jpg?s=612x612&w=0&k=20&c=CK49ShLJwDxE4kiroCR42kimTuuhvuo2FH5y_6aSgEo=" />
                </div>
...
<h3 class="logo1"> <i class="fa-solid fa-bars" onclick="openNav()"></i> Menu <span style="font-size: 15px; color: #00aaff;"><i class="fa-solid fa-house-user"></i> RCC Limited > Home</span></h3>    </div>
 ...
 <liferay-ui:panel-container id="panel-container-1" extended="true"
			...
			extended="true" >
					...
					<liferay-ui:panel id="panel-c2" title="Project Info"
						...
						<div style="display: flex; width: 100%;">
							<fieldset
								style="    border: 1px solid #cbcbcb;width: 50%;margin-right: 3px;padding: 0 1px;">
								<legend
    ...
    width: 118px;"><input type="text"
							...
							<fieldset style="border: 1px solid #cbcbcb; width: 50%;">
								<legend
		...
		<div class="items2">
			<div style="display: flex; flex-direction: row; align-items: center">
				...
				<div class="btns" id="btns">
					<div class="btn "
						style="margin-bottom: 5px; background: #9585bf !important; font-weight: bold; color: #fff; cursor: pointer">Link
						to File</div>
					<div class="btn "
						style="margin-top: 15px; background: #9585bf !important; font-weight: bold; color: #fff; cursor: pointer">Link
						to DropBox</div>

					<div class="btn "
						style="margin-top: 15px; background: #9585bf !important; font-weight: bold; color: #fff; cursor: pointer">
						Upload</div>
				</div>
			</div>
		</div>
	...
	<a id="quotecall" href="${homepage}"	hidden></a>
					</div>
				</div>
			</form>
 </div>
